...
git commit -m "Congress Trades feature complete with backend scraper and watchlist integration"
...
Write-Host "   git remote add origin https://github.com/yourusername/yourrepo.git"
